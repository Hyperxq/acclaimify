...
export const Card = ({
  ...
  const classList =
    'relative overflow-clip grid content-center justify-center w-[686px] h-[504px]';
  return (
    <CardContainer id="card" skipBorders={skipBorders} classList={classList}>
      <div
        className={`bg-white ${toResponsive('w', 545)} ${toResponsive(
          'h',
          425
        )} flex flex-col content-center justify-items-center items-center justify-center`}
      >
        <h3 className={`lato-regular w-fit h-fit ${toResponsive('text', 23)}`}>
          Certificate of achievement
        </h3>
        <h2
          className={`lato-regular w-fit text-[42px] ${toResponsive(
            'text',
            42
          )}`}
        >
        ...
        <h4 className={`lato-regular w-fit  capitalize`}>
          {position ?? 'Fullstack Web Development'}
        </h4>

        <h5
          className={`lato-regular w-fit ${toResponsive(
            'text',
            11
          )} ${toResponsive('pt', 9)}`}
        >
          {projectName ? projectName + ',' : ''} {dateOfAchievement}
        </h5>

        <p
          className={`lato-regular w-fit break-words ${toResponsive(
            'max-w',
            337
          )} ${toResponsive('pt', 23)} ${toResponsive(
            'text',
            16
          )} text-[#6D6D6D] text-center`}
        >
        ...
        >
          <ellipse
            ...
            rx="115.016"
            ry="442.971"
            transform="rotate(-48.6012 46.2069 564.635)"
            fill="#96E8DA"
          />
          <ellipse
            cx="651.381"
            ...
            rx="139.7"
            ry="183.674"
            transform="rotate(-7.87761 651.381 101.532)"
            fill="#C19BFF"
          />
          ...
          <ellipse
            ...
            rx="115.016"
            ry="151.22"
            transform="rotate(-7.87761 -14.6784 179.246)"
            fill="#F9F3AD"
          />
          ...
          <path
            d="M80.0276 338.313C67.3345 346.505 50.4035 342.856 42.2113 330.163C34.0191 317.47 37.6679 300.539 50.361 292.346C63.0542 284.154 79.9852 287.803 88.1774 300.496C96.3696 313.189 92.7208 330.12 80.0276 338.313ZM56.7947 302.315C49.6069 306.954 47.5407 316.541 52.1797 323.729C56.8187 330.917 66.4062 332.983 73.594 328.344C80.7818 323.705 82.848 314.118 78.209 306.93C73.57 299.742 63.9824 297.676 56.7947 302.315Z"
            stroke="#42D4BD"
            strokeWidth="24.8891"
            mask="url(#path-84-inside-1_73_57)"
          />
          ...
          <path
            d="M143.6 127.136C148.811 126.417 153.704 124.211 157.693 120.782C161.682 117.353 164.598 112.846 166.091 107.802C167.584 102.758 167.591 97.3901 166.11 92.3421C164.63 87.2942 161.726 82.7802 157.745 79.341C153.765 75.9017 148.877 73.6831 143.668 72.9511C138.459 72.219 133.149 73.0046 128.375 75.2136C123.601 77.4225 119.565 80.9613 116.751 85.4057C113.937 89.8501 112.464 95.0117 112.508 100.272L124.372 100.171C124.347 97.1922 125.181 94.2693 126.774 91.7526C128.368 89.2358 130.653 87.2319 133.357 85.9811C136.06 84.7302 139.067 84.2853 142.017 84.6999C144.967 85.1144 147.735 86.3707 149.989 88.3183C152.243 90.2658 153.887 92.822 154.726 95.6805C155.564 98.539 155.56 101.579 154.715 104.435C153.869 107.291 152.218 109.843 149.959 111.785C147.7 113.727 144.929 114.976 141.979 115.384L143.6 127.136Z"
            stroke="#42D4BD"
            strokeWidth="24.8891"
            mask="url(#path-85-inside-2_73_57)"
          />
        </svg>

        <svg
          className="absolute right-[81px] bottom-[62px]"
          width="80"
          height="111"
          viewBox="0 0 80 111"
          fill="none"
